import admissionsImage from "../assets/aboutImage.jpg";
import admissionsImage2 from "../assets/event1.jpg";
  ...
  return (
    <div>
      ...
      <div className="my-20 max-w-screen-lg m-auto space-y-8">
        ...
        <button className="bg-custom-green text-white py-2 px-6">Contact our Admission team</button>
      </div>
    </div>
  )
}
