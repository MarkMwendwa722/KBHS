...
import subjectsImage from '../assets/academics-header.jpg';  
...
function Academics() {
  ...
  <section className="mb-12">
    ...
    <ul className="list-disc list-inside text-black mb-8 text-lg font-semibold ">
    ...
    <ul className="list-disc list-inside text-black font-semibold mb-8 text-lg">
    ...
    <ul className="list-disc list-inside text-black font-semibold text-lg">
