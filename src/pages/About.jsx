    ...
    <div>
      ...
      <div>
        <div className="h-[30vh] relative">
          <img
            src="https://d24fkeqntp1r7r.cloudfront.net/wp-content/uploads/2020/11/08041438/Untitled-design-2020-12-08T151337.059.png"
      ...
      <div>
        ...
        <div className="my-20 mx-40 flex justify-center h-[500px] gap-5">
            <div className="relative">
                <img src="https://i2-prod.walesonline.co.uk/incoming/article25509109.ece/ALTERNATES/s615/0_RNP_MAI_100621Lee001-1JPG.jpg" alt="head teacher" className="h-[100%] object-cover w-[400px]" />
                <div className="absolute bottom-5 bg-[#FFFDD0] w-full py-4 text-center flex flex-col gap-1 font-bold">
                    <span>SIR SAMUEL MARK</span>
                    <span className="text-xs font-normal">SCHOOL HEAD TEACHER</span>
                </div>
            </div>
            <div className="relative">
                <img src="https://www.ziprecruiter.com/svc/fotomat/public-ziprecruiter/cms/175173496SocialStudiesTeacher.jpg=ws1280x960" alt="deputy teacher" className="h-[100%] object-cover w-[400px]"/>
                <div className="absolute bottom-5 bg-[#FFFDD0] w-full py-4 text-center flex flex-col gap-1 font-bold">
                    <span>MRS LAUREL SALLY</span>
                    <span className="text-xs font-normal">SCHOOL DEPUTY TEACHER</span>
                </div>
            </div>
        </div>
      </div>
